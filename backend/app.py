...
import ollama
from fastapi.middleware.cors import CORSMiddleware        #safety ke liye hai, connection b/w backend & frontend
...
chat_history = [
    {"role": "system", "content": "You are Jarvis, an AI assistant that can control the user's PC safely."}
]
